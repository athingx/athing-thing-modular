...
import io.github.athingx.athing.aliyun.modular.impl.util.FileUtils;
import io.github.athingx.athing.aliyun.modular.impl.util.HttpUtils;
        ...
        final ListenableFuture<File> future = new Promisor()
                ...
                .onFailure(cause -> {
                    if (cause instanceof ModuleUpgradeProcessException) {
                        final ModuleUpgradeProcessException mupE = (ModuleUpgradeProcessException) cause;
